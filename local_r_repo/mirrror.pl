...
my $excludes = "--exclude '**windows*' --exclude '**macosx/' --exclude '**linux*' --exclude 'CRAN/bin*' --exclude 'bioc/bin*' --exclude 'bioc/citations*' --exclude 'bioc/html*' --exclude 'bioc/install*' --exclude 'bioc/licenses*' --exclude 'bioc/manuals*' --exclude 'bioc/news*' --exclude 'bioc/readmes*' --exclude 'bioc/vignettes*' --exclude 'contrib/Archive*'";
